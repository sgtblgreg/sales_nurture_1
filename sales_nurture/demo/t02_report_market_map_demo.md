<div class="reportHeader">
  <div>
    ...
    <div class="reportSub">DEMO • День 10 • цель: показать структуру спроса по сегментам/потребностям и собрать связки Segment → Need → Functions</div>
  </div>
</div>
...
<div class="kpiGrid">
  <div class="kpiCard">
    ...
    <div class="kpiNote">В очереди (найдено, но не обработано): <b>8 143</b>. DEMO‑версия показывает механику без реальных источников.</div>
